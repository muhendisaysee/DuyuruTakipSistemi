...
import static duyurutakipsistemi.AkademisyenHesapController.teknoparkDuyuru;
import static duyurutakipsistemi.AkademisyenHesapController.toplulukDuyuru;
...
import static duyurutakipsistemi.ToplulukDuyuruDuzenleController.duyuruListele;
 ...
 * @author hp
 */
public class ToplulukHesapController extends AbstractController implements Initializable {
    ...
    private void duzenle(ActionEvent a) {
        try {
            Parent tableViewParent = FXMLLoader.load(getClass().getResource("ToplulukDuyuruDuzenle.fxml"));
            Scene tableview = new Scene(tableViewParent);
            Stage window = (Stage) ((Node) a.getSource()).getScene().getWindow();
            window.setScene(tableview);
            window.show();
