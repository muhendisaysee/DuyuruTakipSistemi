 ...
 * @author hp
 */
public class AkademisyenHesapController extends AbstractController implements Initializable {
    ...
    private void duzenle(ActionEvent a) {
        ...
        try {
            Parent tableViewParent = FXMLLoader.load(getClass().getResource("AkademikDuyuruDuzenle.fxml"));
